...
class BaseModelClass:
    def __init__(self, model_index, model, model_storage, session_id, tool_list):
        system_prompt_description = f"You are a part of a conversation with other models where you are referred to \
            ...
            you used its output in your response and do so specifically so that we know you used the tool's output."
        self.agent = Agent(
            model=model,
